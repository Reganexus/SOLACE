...
class UserProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Retrieve the current user data for display
    final userData = Provider.of<UserData?>(context); // Ensure this matches your UserData provider

    // Debugging to see if userData is being retrieved correctly
    // ignore: avoid_print
    print('UserData: ${userData.toString()}'); // Check if userData is null or contains the expected data
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildProfileInfoSection('House Address', userData?.address ?? 'N/A'), // Adjust accordingly
                  ],
                ),
              ),
            ),
