...
class CaregiverProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        'User Profile: $user'); // Check if userData is null or contains the expected data
                  ...
                  children: [
                    ...
                    Center(
                      child: Row(
                        ...
                        children: [
                          Text(
                            '${userData?.firstName ?? 'N/A'} ${userData?.middleName ?? ''} ${userData?.lastName ?? 'N/A'}',
                            style: TextStyle(
                              fontSize: 20.0,
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _buildProfileInfoSection('Email Address',
                            userData?.email ?? 'N/A'), // Updated email
                        ...
                        _buildProfileInfoSection(
                            'House Address',
                            userData?.address ??
                                '123 Sample Street'), // Adjust accordingly
                        _buildProfileInfoSection('Gender',
                            userData?.sex ?? 'N/A'), // Provide default value
