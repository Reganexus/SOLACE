...
class PatientHistoryState extends State<PatientHistory> {
  ...
  Widget _buildVitalChartSection(String title, List<double> vitalData, List<DateTime> timestamps) {
    return Column(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildVitalChartSection(
                          'Blood Pressure', filteredBloodPressure, filteredTimestamps),
                      _buildVitalChartSection(
                          'Heart Rate', filteredHeartRate, filteredTimestamps),
                      _buildVitalChartSection(
                          'Temperature', filteredTemperature, filteredTimestamps),
                      _buildVitalChartSection(
                          'Oxygen Saturation', filteredSaturation, filteredTimestamps),
                      _buildVitalChartSection(
                          'Respiration', filteredRespiration, filteredTimestamps),
                      _buildVitalChartSection(
                          'Pain Level', filteredPainLevel, filteredTimestamps),
                    ],
                  ),
                ),
              ),
