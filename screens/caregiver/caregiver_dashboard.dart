  ...
  void _handleQRScanResult(BuildContext context, String result) async {
    try {
      ...
      if (result == currentUserId) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('You cannot send a healthcare request to yourself!')),
        );
        return;
      }
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                // Updated TextButton for Scan QR
                                TextButton.icon(
                                  onPressed: () async {
                                    try {
